...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_nombre1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, -1));
        ...
        txt_RegistradoPor.setName(""); // NOI18N
        ...
        jButton_Actualizar1.setBackground(new java.awt.Color(153, 153, 255));
        jButton_Actualizar1.setFont(new java.awt.Font("Arial Narrow", 0, 18)); // NOI18N
        ...
        getContentPane().add(jButton_Actualizar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 250, 210, 35));
    ...
    private void jButton_Actualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Actualizar1ActionPerformed
        ...
        status_cmb = cmb_estatus.getSelectedIndex() + 1;
        ...
        if (validacion == 0) {
            ...
            JOptionPane.showMessageDialog(null, "Debes colocar todos los campos.");
        }
