...
public class Informacion_Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_UltimaModificacon = new javax.swing.JLabel();
        ...
        jButton_ImprirReporte = new javax.swing.JButton();
        ...
        jLabel_UltimaModificacon.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_UltimaModificacon.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_UltimaModificacon.setText("Ultima Modificación por: ");
        getContentPane().add(jLabel_UltimaModificacon, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, -1, -1));
        ...
        jButton_ImprirReporte.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/impresora.png"))); // NOI18N
        jButton_ImprirReporte.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_ImprirReporteActionPerformed(evt);
            }
        });
        getContentPane().add(jButton_ImprirReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 250, 120, 100));
    ...
    private void jButton_ImprirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprirReporteActionPerformed
        ...
        try {
            ...
            documento.close();
            JOptionPane.showMessageDialog(null, "Reporte crteado correctamente.");
        } catch(DocumentException | IOException e) {
            System.err.println("Error en PDF o ruta de imagen." + e);
            JOptionPane.showMessageDialog(null, "Error al generar PDF, contacte al administrador.");
        }
    }//GEN-LAST:event_jButton_ImprirReporteActionPerformed
    ...
    private javax.swing.JButton jButton_ImprirReporte;
    private javax.swing.JButton jButton_Registrar;
    private javax.swing.JLabel jLabel_UltimaModificacon;
